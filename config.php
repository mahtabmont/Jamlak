...
define('OW_URL_HOME', 'http://aut-alumni.ir/');

define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'kodoomco_user');
define('OW_DB_PASSWORD', 'ras1350');
define('OW_DB_NAME', 'kodoomco_ox_db');
...
define('OW_PASSWORD_SALT', 'Ew2TiPada51tir1h');
